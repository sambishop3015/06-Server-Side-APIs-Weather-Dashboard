...
$(document).ready(function () {
  ...
  function searchWeather() {
    var queryURL1 = "https://cors-anywhere.herokuapp.com/https://api.openweathermap.org/data/2.5/weather?q=" + loadSearch + "&appid=0d23ce5bcc2e4f505cf7ec85adf351ab";
    $.ajax({
      url: queryURL1,
      method: "GET"
      ...
      var queryURL2 = "https://cors-anywhere.herokuapp.com/https://api.openweathermap.org/data/2.5/onecall?lat=" + lat + "&lon=" + lon + "&exclude=hourly,daily&appid=0d23ce5bcc2e4f505cf7ec85adf351ab";
      $.ajax({
        url: queryURL2,
        method: "GET"
      }).then(function (response) {
      ...
      var queryURL3 = "https://cors-anywhere.herokuapp.com/https://api.openweathermap.org/data/2.5/forecast?q=" + loadSearch + "&appid=0d23ce5bcc2e4f505cf7ec85adf351ab";
      $.ajax({
        url: queryURL3,
        method: "GET"
      }).then(function (response) {
